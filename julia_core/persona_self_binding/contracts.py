...
class PersonaSelfBindingErrorCode(str, Enum):
    ...
    PSB_PROJECTION_INVALID_INPUT = "PSB_PROJECTION_INVALID_INPUT"
    PSB_PROJECTION_DIGEST_MISMATCH = "PSB_PROJECTION_DIGEST_MISMATCH"
    PSB_PROJECTION_UNBOUND_IDENTITY = "PSB_PROJECTION_UNBOUND_IDENTITY"
    PSB_PROJECTION_UNBOUND_EXPERIENCE = "PSB_PROJECTION_UNBOUND_EXPERIENCE"
    PSB_PROJECTION_RELATIONSHIP_STATE_INVALID = (
        "PSB_PROJECTION_RELATIONSHIP_STATE_INVALID"
    )
    PSB_PROJECTION_UNRESOLVED_IDENTITY_OVERRIDE = (
        "PSB_PROJECTION_UNRESOLVED_IDENTITY_OVERRIDE"
    )
    PSB_PROJECTION_PROVIDER_FIELD_FORBIDDEN = "PSB_PROJECTION_PROVIDER_FIELD_FORBIDDEN"
    PSB_PROJECTION_V2_INVALID_INPUT = "PSB_PROJECTION_V2_INVALID_INPUT"
    PSB_PROJECTION_V2_CLAUSE_SOURCE_MISMATCH = (
        "PSB_PROJECTION_V2_CLAUSE_SOURCE_MISMATCH"
    )
    PSB_PROJECTION_V2_CLAUSE_DIGEST_MISMATCH = (
        "PSB_PROJECTION_V2_CLAUSE_DIGEST_MISMATCH"
    )
    PSB_PROJECTION_V2_CLAUSE_ORDER_MISMATCH = "PSB_PROJECTION_V2_CLAUSE_ORDER_MISMATCH"
    PSB_PROJECTION_V2_NON_DETERMINISTIC_SERIALIZATION = (
        "PSB_PROJECTION_V2_NON_DETERMINISTIC_SERIALIZATION"
    )
    PSB_PROJECTION_V2_UNBOUND_CLAUSE = "PSB_PROJECTION_V2_UNBOUND_CLAUSE"
    PSB_PROJECTION_V2_PROVIDER_IDENTITY_FORBIDDEN = (
        "PSB_PROJECTION_V2_PROVIDER_IDENTITY_FORBIDDEN"
    )
    PSB_PROJECTION_V2_CONTRADICTS_CANONICAL_FIELDS = (
        "PSB_PROJECTION_V2_CONTRADICTS_CANONICAL_FIELDS"
    )
