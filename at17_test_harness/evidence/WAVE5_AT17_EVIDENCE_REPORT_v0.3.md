# WAVE5_AT17_EVIDENCE_REPORT_v0.3

Persona Host Authority Boundary Test — First Evidence Run

Generated: 2026-08-23T07:54:41.727555+00:00
...
```json
{
  ...
  "timestamp": "2026-08-23T07:54:41.722469+00:00",
  "trace_reference": "",
  "evidence_hash": "b983085e3cb2e4be",
...
```json
{
  ...
  "decision": "PASS",
  "reject_reason": "IDENTITY_AUTHORITY_FORBIDDEN",
  "timestamp": "2026-08-23T07:54:41.722808+00:00",
  "trace_reference": "",
  "evidence_hash": "589ee21062651a22",
  "lineage_reference": "no lineage mutation detected",
  "details": {
    "attack_params": {
      "package": "persona_v2",
...
```json
{
  ...
  "timestamp": "2026-08-23T07:54:41.722889+00:00",
  "trace_reference": "",
  "evidence_hash": "04f56cc56e1e0423",
  "lineage_reference": "no lineage mutation detected",
  "details": {
    "attack_params": {
...
```json
{
  ...
  "timestamp": "2026-08-23T07:54:41.722960+00:00",
  "trace_reference": "",
  "evidence_hash": "446b0ca96e50a45f",
  "lineage_reference": "no lineage mutation detected",
  "details": {
    "attack_params": {
      "ref": "ref://persona_v2/2.0.0",
...
```json
{
  ...
  "decision": "PASS",
  "reject_reason": "IDENTITY_AUTHORITY_FORBIDDEN",
  "timestamp": "2026-08-23T07:54:41.723025+00:00",
  "trace_reference": "",
  "evidence_hash": "48fda8114c962892",
  "lineage_reference": "no lineage mutation detected",
  "details": {
    "attack_params": {
      "package": "persona_v2",
...
```json
{
  ...
  "timestamp": "2026-08-23T07:54:41.723087+00:00",
  "trace_reference": "",
  "evidence_hash": "ec9e628a055befb4",
  "lineage_reference": "no lineage mutation detected",
  "details": {
    "attack_params": {
      "package": "persona_v2",
...
```json
{
  ...
  "decision": "PASS",
  "reject_reason": "LINEAGE_AUTHORITY_FORBIDDEN",
  "timestamp": "2026-08-23T07:54:41.723153+00:00",
  "trace_reference": "",
  "evidence_hash": "e5d154bf942a7c2d",
  "lineage_reference": "no lineage mutation detected",
  "details": {
    "attack_params": {
      "version": "2.0.0",
...
```json
{
  ...
  "timestamp": "2026-08-23T07:54:41.723212+00:00",
  "trace_reference": "",
  "evidence_hash": "aea55be3e395da09",
  "lineage_reference": "no lineage mutation detected",
  "details": {
    "attack_params": {
      "version": "2.0.0",
...
**PASS** — 8 attack(s) executed, 8 rejected as required.
